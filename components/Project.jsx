...
const Project = ({isDarkMode}) => {
  return (
    ...
    transition={{duration:1}} id='project' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <motion.p initial ={{opacity:0}}
         ...
         transition={{duration:0.5, delay:0.7}}className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
            Welcome to my web development Portfolio! Explore a collection of projects showcasing my expertise in fullstack
        </motion.p>
        <motion.div 
        initial ={{opacity:0}}
        whileInView={{opacity:1}}
